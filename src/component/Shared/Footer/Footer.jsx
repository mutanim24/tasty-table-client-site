...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-sky-100 text-base-content">
            <div>
                <span className="footer-title">We are</span>
                <a className="link link-hover">About us</a>
                <a className="link link-hover">Contact us</a>
                <a className="link link-hover">Privacy policy</a>
            </div>
            <div className='w-8/12'>
                <span className="footer-title">Recipe category</span>
                <a className="link link-hover">Rice platter</a>
                <a className="link link-hover">First food</a>
